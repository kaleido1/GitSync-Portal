...
Download `main.js`, `manifest.json`, and `styles.css` from the [GitHub release](https://github.com/kaleido1/GitSync-Portal/releases/tag/2.1.11) and place them directly in:
