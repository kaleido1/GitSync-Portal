...
Download [gitsync-portal-2.1.4.zip](https://github.com/kaleido1/GitSync-Portal/releases/download/2.1.4/gitsync-portal-2.1.4.zip) and extract it into your vault's plugin directory:
