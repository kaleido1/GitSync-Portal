...
Download the three community-plugin assets from the [2.1.10 release](https://github.com/kaleido1/GitSync-Portal/releases/tag/2.1.10): `main.js`, `manifest.json`, and `styles.css`. Place them in:
